...
The researchers suggested that this may have been because mobile devices, being so portable and easy for a child to bring with them everywhere (such as the grocery store, doctor's offices, etc.), can seep into more aspects of their daily life and development than TV or computer use can, because it is fixed to one place and only usable from there. Because mobile devides have the capacity to follow young children wherever they go, there is more of an opportunity there for extreme amounts of screen-time to limit aspects of development such as self-regulation.

### The Limitations

No study is perfect - they all have their limitations. As for this study, these limitations should be noted...
...
* **Cross-sectional research.** It is important to note that this study was done in a "cross-sectional" matter, meaning that information was collected from these children at only one point in time. This means that any child's change over time due to screen usage cannot be assessed in this study. Ideally, what we would want from a study would be for children to be measured over long periods of time - and then compared to themselves - to see how screen time has affected each and every child on their own. In this study however, children had to be compared to others on measures of self-regulation. Using this method, there is the risk that whatever differences the study found could have just been differences in the children themelves - potentially due to other familial factors, parenting style, or personality, instead of screen use.
