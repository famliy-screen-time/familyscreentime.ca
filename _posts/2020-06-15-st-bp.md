...
While screen usage and sedentary behaviour can often be the same thing (i.e. children sitting and watching television or playing on a mobile device), **it doesn't always have to be this way**! It is possible to  separate screen usage from inactivity - and even to bring screen use into physical activity - by choosing screens for your child that incorporate physical activity, movement, and utilization of motor skills. I have proposed a few ways to do this in a [previous blog post](https://familyscreentime.ca/2020-06-08-screen-time-schedules). Essentially, it may be possible to break the link between screen usage and lower motor skills by breaking the link between screen usage and inactivity - which is, in my opinion, the true culprit in this story.