...
While it is a good idea to go to the website being linked and investigate just how reliable it is, you can often tell when a claim is not-so-solid just by looking at the URL to the website. For example, if a post titled "*Scientists Prove that TV Harms Children's Brains*" links to a source with a URL such as "*newsinformation.truth.myblog.net*", you can already question the truth of this claim without even visiting the webpage - although you should still take a look.
...
When an article or post makes a claim such as "*Screen Time Leads to Lower IQ*" 
