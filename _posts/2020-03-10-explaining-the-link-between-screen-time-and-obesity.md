...
This research included studies establishing a positive correlation between child screen usage and increased risk of obesity - meaning that higher levels of screen use were related to higher obesity risk. Correlational research is not completely trustworthy, however, because it does not mean that one thing necessarily caused the other. This correlation between screen use and obesity could mean that a) screen use caused obestity, b) obesity caused screen use. or c) something else caused both of these things. 

However, not only did the research find a correlation between screen use and obesity, but a few "randomized controlled trials" - which is another name for a powerful study that is able to establish cause-and-effect relationships - found that overall, higher levels of screen time led to higher BMI's in young children.
